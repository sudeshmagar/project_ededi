...
import { SearchIcon, MailIcon, BellIcon, UserAddIcon, UserCircleIcon, AdjustmentsIcon, UserGroupIcon, UsersIcon, CogIcon, LogoutIcon } from '@heroicons/react/outline';
              ...
              <div className='searchbox'>
                <form className='flex flex-row items-center'>
                  <div className='relative'>
                    <input type='text' id='search' name='search' placeholder='Search' className='peer px-4 py-3 rounded-full border-none placeholder-transparent dark:bg-slate-800' />
                    <label htmlFor='search' className='absolute flex items-center left-[15px] text-xs text-gray-500 top-0 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-3'>Search <SearchIcon className='h-4 w-4 inline-flex' /></label>
                  </div>
                </form>
              </div>
